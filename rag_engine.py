...
#         logger.info("RAG Engine initialized successfully.") --normal mode
class RAGEngine:
    def __init__(
        self,
        retriever: LeetCodeRetriever,
    ...
    def set_mode(self, mode: str):
        ...
        self.mode = mode
        logger.info(f"Mode set to: {mode}")  # --normal+reasoning mode
    ...
    # """
    #     return prompt -- prev prompt model
    ...
    #                         "theory", "explanation", "description", "overview", 'Explain']
    ...
    #     """
    #     return prompt --prev prompt model (worst case)
    ...
    #     except Exception as e:
    #         logger.error(f"Failed to answer question: {e}")
    #         return "An error occurred while generating the response.", ContextMetadata(0.0, [], [], []) --nomal mode
...
#     print(f"Edge Cases: {', '.join(metadata.edge_cases)}") --normal mode test
